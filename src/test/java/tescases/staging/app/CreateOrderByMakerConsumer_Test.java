...
public class CreateOrderByMakerConsumer_Test extends BaseTest {
    private TestOrder_Model order = new TestOrder_Model();

    @BeforeMethod
    public void setUp() throws Exception {
        order.setCustomerName("Danish Two Consumer");
        ...
        order.setCustomerAddress("Danish Two Consumer\r\n" + "Kløvermarksvej 70D\r\n" + "Apt\r\n" + "2300 Copenhagen\r\n" + "Denmark");
...
//
        ...
        assertTrue(pdfExtractedContent.contains("WINE Wine (ECO) 1 12,50 12,50"));
        assertTrue(pdfExtractedContent.contains("DK-ØKO-100"));
        assertTrue(pdfExtractedContent.contains("Included VAT (25%): 2,50"));
